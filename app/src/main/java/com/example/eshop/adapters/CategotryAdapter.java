...
import com.example.eshop.databinding.ItemCategoryBinding;
import com.example.eshop.models.Category;

import java.util.ArrayList;

public class CategotryAdapter extends RecyclerView.Adapter<CategotryAdapter.CategoryViewHolder>{

    Context context;
    ArrayList<Category> categories;

    public CategotryAdapter(Context context,ArrayList<Category> categories){
